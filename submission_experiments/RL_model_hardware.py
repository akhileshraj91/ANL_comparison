...
LOGS_CONF = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': f'/home/cc/compare_control_methods/submission_experiments/experiment_data/CC_RL_control/{LOGGER_NAME}.log',
            'mode': 'w',
            'level': LOGS_LEVEL,
            'formatter': 'precise',
            'filters': [],
...
def initialize_csvwriters(stack: contextlib.ExitStack):
    csvfiles = {
        msg_type: stack.enter_context(open(f'/home/cc/compare_control_methods/submission_experiments/experiment_data/CC_RL_control/dump_{msg_type}.csv', 'w'))
