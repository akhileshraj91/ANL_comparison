...
LOGS_CONF = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': f'/home/cc/compare_control_methods/IC2E/results/optimal/{LOGGER_NAME}.log',
            'mode': 'w',
            'level': LOGS_LEVEL,
            'formatter': 'precise',
            'filters': [],
...
def initialize_csvwriters(stack: contextlib.ExitStack):
    csvfiles = {
        msg_type: stack.enter_context(open(f'/home/cc/compare_control_methods/IC2E/results/optimal/dump_{msg_type}.csv', 'w'))
