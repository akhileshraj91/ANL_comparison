...
clusters = [cluster for cluster in next(os.walk(experiment_dir))[1] if 'control' in cluster]
# print(">>>>>>>>>>",clusters)
...
color_index = {'CC_RL_control':'r','CC_control':'b'}
marker_index = {'CC_RL_control':'+','CC_control':'v'}
...
# plt.show()
fig.savefig("_Results_"+str(now)+".pdf")